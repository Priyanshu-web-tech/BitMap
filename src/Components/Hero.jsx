          ...
          >
            ...
            <div className="mt-10 flex items-center justify-center gap-x-2">
              <a href="#table">
                <button
                  type="button"
                  className="rounded-md border border-gray-400 px-3 py-2 text-sm font-semibold text-gray-400 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                >
                 Get Started
                </button>
              </a>
